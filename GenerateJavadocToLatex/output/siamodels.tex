...
\item \texttt{public boolean hasTempuhKuliah(java.lang.String kodeMataKuliah)}Memeriksa apakah mahasiswa ini sudah pernah menempuh mata kuliah tertentu. Kompleksitas O(n).
...
\item \texttt{public int getTahunAngkatan()}Mendapatkan tahun angkatan mahasiswa ini, berdasarkan NPM nya
