...
%\includepdf[page=1, noautoscale=true]{./Lampiran/programsederhana.pdf}
%{
%  \centering
%  \includegraphics[page=2, scale=1]{./Lampiran/operasimatematika.pdf}
%  \captionof{figure}{Hasil Pengujian Kode Program Sederhana}
%}
%\includepdf[page=1-2]{./Lampiran/javadoctolatex.pdf}
%{
%  \centering
%  \includegraphics[page=3, scale=1]{./Lampiran/javadoctolatex.pdf}
%  \captionof{figure}{Hasil Pengujian Kode Program Perangkat Lunak}
%}

\lstinputlisting[language=TeX, caption=siamodels.tex]{./Lampiran/siamodels.tex}
\newgeometry{scale=1}
\thispagestyle{empty}
\includepdf[page=1-43]{./Lampiran/siamodels.pdf}
{
  \centering
  \includegraphics[page=44, scale=1]{./Lampiran/siamodels.pdf}
  \captionof{figure}{siamodels.pdf}
}
\restoregeometry
