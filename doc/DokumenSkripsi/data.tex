...
%=============================================================================
\judulINA{Konversi Javadoc ke \LaTeX}
\judulENG{Javadoc to \LaTeX\ Conversion}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
\abstrakENG{
Student Thesis The Informatics Engineering and Science Faculty (FTIS) Informatics Engineering Study Program at Parahyangan Catholic University (Unpar) is making software. Software made generally uses the programming language Java. As explained, the programming language Java has Javadoc as information from the class, interface, method and also custom tag created, so that the information can be used as an explanation of the software in the software documentation. To document the software created, all students are required to use \LaTeX\ in making a Thesis documentation. \LaTeX\ is the language markup to compile a documentation. \LaTeX\ makes what is displayed the same as what was written. Generally the final form of a document created by \LaTeX\ is usually a file PDF.

In one of the Thesis documentation chapters, there is an explanation of each class in the software made. This explanation can actually be taken from Javadoc which was created in the Java class, but currently based on these observations it is still manually typed from Javadoc into the \LaTeX format, so that it takes more time to document each class in the software created.
