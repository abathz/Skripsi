...
\usepackage{pgfplots}
\usepackage{pdfpages, graphicx, caption}
...
%=============================================================================
\namanpm{Adli Fariz Bonaputra}{2012730082}
\tanggal{18}{12}{2018}
\pembimbing{\VSM}{}    
\penguji{\TAB}{\ELH} 
%=============================================================================
...
%=============================================================================
\judulINA{Perangkat Lunak Konversi Komentar Java ke \LaTeX}
\judulENG{Java Comment to \LaTeX\ Software Conversion}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
\abstrakENG{
The purpose of the undergraduate thesis is the Information Technology and Science Faculty (FTIS) Informatics Engineering Study Program at Parahyangan Catholic University (Unpar) is to make software. Software made generally uses the programming language {\it Java}. The programming language {\ it Java} has useful comments as information from the class, {\it interface}, {\it method} and also {\it custom tag} created, so that the information can be used as a software explanation in the device documentation soft. To document the software made, all students are required to use \LaTeX\ in making a thesis documentation. \LaTeX\ is the language of {\it markup} to compile a documentation. Language {\it markup} is a language that annotates documents by adding certain syntax so that they can be distinguished. \LaTeX\ can produce structured documents as written by the author. Generally the final form of a document created by \LaTeX\ is usually a {\it file} PDF.

In one of the thesis documentation chapters, there is an explanation of each class in the software created. This explanation can actually be taken from {\it Javadoc} which was created in the {\it Java} class, but currently based on these observations it is still typed manually from {\it Javadoc} into the format \LaTeX, so that it takes more time to document each class in the software created.

Therefore, it is necessary to develop a software that can extract information on {\it Javadoc} to \LaTeX\ format automatically. This software implements a {\it Application Programming Interface} (API) which is used to retrieve information in the form of a class name, {\it interface}, {\it method} and also {\it custom tag} contained in a {\it Java file}.
} 
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{Skripsi, {\it Javadoc}, {\it Doclet}, \LaTeX}
\kunciENG{Thesis, Javadoc, Doclet, \LaTeX}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\untuk{Keluarga, karmila, orang terdekat dan diri sendiri}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\prakata{Puji syukur kepada Tuhan Yang Maha Esa atas seluruh berkat yang diberikan kepada penulis sehingga dapat menyelesaikan tugas akhir dengan judul Perangkat Lunak Konversi Komentar Java ke \LaTeX\ dengan baik dan tepat waktu. Penulis juga berterima kasih kepada pihak-pihak yang telah memberikan dukungan dan bantuan kepada penulis dalam menyelesaikan tugas akhir ini, yaitu:
\begin{enumerate}
  ...
  \item Bapak Thomas Anung Basuki dan Bapak Elisati sebagai dosen penguji yang telah membantu dalam menguji tugas akhir ini.
  \item Karmila Puspitasari yang tidak pernah berhenti untuk selalu menemani, memberikan dukungan dan memberikan semangat kepada penulis hingga dapat menyelesaikan tugas akhir ini.
  \item Andre dan Momon yang sampai penulis tidak tahu harus berkata-kata apa. Terima kasih.
  \item Teman-teman Zero Hour Coffee dan Bahagia Kopi yang selalu memberikan semangat dan dukungan.
  \item Teman-teman kontakan 7B yang sudah memberikan tempatnya sebagai tempat penulis mencari inspirasi.
